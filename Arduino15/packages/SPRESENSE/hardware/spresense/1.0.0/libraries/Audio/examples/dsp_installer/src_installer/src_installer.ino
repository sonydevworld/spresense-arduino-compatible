/*
 *  src_installer.ino - SRC(Sampling Rate Converter) dsp installer
 ...
 *  A range of Audio DSP functions are available. This skecth loads SRC.
 *
 *  Run the sketch and you should see
 *    Select where to install SRC?
 ...
 *  If '1' is input,
 *    Install: /mnt/sd0/BIN/SRC Done.
 *  If '2' is input,
 *    Install: /mnt/spif/BIN/SRC Done.
 *    Finished.
 *
...
void setup()
{
  ...
  // Display Menu
  Serial.println("Select where to install SRC?");

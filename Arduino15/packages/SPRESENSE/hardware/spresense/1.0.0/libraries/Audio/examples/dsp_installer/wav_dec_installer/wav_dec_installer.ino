/*
 *  wav_dec_installer.ino - WAV decoder dsp installer
 ...
 *  A range of Audio DSP functions are available. This skecth loads WAV decoder.
 *
 *  Run the sketch and you should see
 *    Select where to install WAVDEC?
 ...
 *  If '1' is input,
 *    Install: /mnt/sd0/BIN/WAVDEC Done.
 *  If '2' is input,
 *    Install: /mnt/spif/BIN/WAVDEC Done.
 *    Finished.
 *
...
void setup()
{
  ...
  // Display Menu
  Serial.println("Select where to install WAVDEC?");

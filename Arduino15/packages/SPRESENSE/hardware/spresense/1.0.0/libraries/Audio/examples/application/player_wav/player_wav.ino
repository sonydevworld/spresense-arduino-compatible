...
WavContainerFormatParser s_parser;
...
void setup()
{
  ...
  handel_wav_parser_t *handle = (handel_wav_parser_t *)s_parser.parseChunk("/mnt/sd0/Sound.wav", &fmt);
  if (handle == NULL)
    {
  ...
  s_parser.resetParser((handel_wav_parser *)handle);

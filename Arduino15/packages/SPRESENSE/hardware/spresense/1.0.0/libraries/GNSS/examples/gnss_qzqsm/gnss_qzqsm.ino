/*
 *  gnss_qzqsm.ino - GNSS NMEA QZQSM example application
 ...
 * @brief GNSS NMEA QZQSM example application
 * @details This skecth provides an example of NMEA DC report output.
 */

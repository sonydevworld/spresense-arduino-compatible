/*
 *  gnss_nmea.ino - GNSS NMEA example application
 ...
 * @brief GNSS NMEA example application
 * @details This skecth provides an example of NMEA output.
 */

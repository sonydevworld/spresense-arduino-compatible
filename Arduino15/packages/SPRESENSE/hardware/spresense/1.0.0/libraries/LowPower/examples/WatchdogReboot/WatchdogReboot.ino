/*
 *  WatchdogReboot.ino - Example for system reboot by watchdog
...
void setup()
{
  ...
  if (bc == WDT_REBOOT) {
    // Save the number of reboots into EEPROM
    EEPROM[0]++;
  }
  ...
  // System reboot by watchdog
  Serial.print("Reboot by watchdog...");
  Watchdog.begin();
  Watchdog.start(2000);
}
